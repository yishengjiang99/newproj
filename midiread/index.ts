...
export function readMidi(buffer: Uint8Array) {
  ...
  var fgetc = reader.fgetc,
    btoa = reader.btoa,
    read32 = reader.read32,
    read16 = reader.read16,
    read24 = reader.read24,
    fgets = reader.fgets,
    fgetnc = reader.fgetnc,
    readVarLength = reader.readVarLength;

  const chunkType = fgetnc(4);
